...
export const stepRecordSchema = z.object({
  ...
  cumulativeCostUsd: z.number().nonnegative().nullable(),
  ...
  stepCostUsd: z.number().nonnegative().nullable(),
...
export const traceSkipSchema = z.object({
  type: z.literal('skip'),
  attemptedStep: z.number().int().nonnegative(),
  action: z.string(),
  reasoning: z.string(),
  observation: z.string(),
  inputTokens: z.number().int().nonnegative(),
  ...
  notepad_contents: z.string().optional().default(""),
  timestamp: z.string(),
});
